...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    addMatchButton.addEventListener('click', async () => {
        matchForm.reset();
        matchIdInput.value = ''; // Vyčisti ID pre nový zápas
        ...
        matchHomeTeamSelect.innerHTML = '<option value="">Vyberte tím</option>'; // Vyčisti tímy
        matchAwayTeamSelect.innerHTML = '<option value="">Vyberte tím</option>'; // Vyčisti tímy
    ...
    async function deleteMatch(matchId) {
        if (!confirm('Naozaj chcete zmazať tento zápas?')) { // Použiť vlastné modálne okno
            return;
        }
        try {
    ...
    filterMatchNameInput.addEventListener('input', applyFilters);
    ...
    function applyFilters() {
        const filters = {
            ...
            matchName: filterMatchNameInput.value.trim(),
            date: filterDateSelect.value,
            location: filterLocationSelect.value
        };
