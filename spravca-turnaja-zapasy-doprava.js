                ...
                sortedDates.forEach(date => {
                    ...
                    eventsForLocationAndDate.forEach(event => {
                        ...
                        if (event.type === 'match') {
                            ...
                            contentHtml = `
                                <p class="schedule-cell-time">${event.startTime} - ${event.endTime}</p>
                                <p class="schedule-cell-bus-name">Autobus: ${event.busName}</p>
                                <p class="schedule-cell-bus-route">${event.startLocation} &rarr; ${event.endLocation}</p>
                                ${event.notes ? `<p class="schedule-cell-bus-notes">${event.notes}</p>` : ''}
                            `;
                        ...
                        scheduleHtml += `
                            <div class="${eventClass}"
                                ...
                                style="position: absolute; left: ${eventBlockLeftPx}px; width: ${eventBlockWidthPx}px; top: ${topPx}px; height: ${ITEM_HEIGHT_PX}px; z-index: 5;">
